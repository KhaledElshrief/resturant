  ...
  return (
    <div className='w-full bg-white py-16 px-4'>
        ...
        <div className='max-w-[1240px] mx-auto grid md:grid-cols-2'>
            <img className='w-[550px] mx-auto my-4' src='https://res.cloudinary.com/daesz5k6b/image/upload/v1696855392/FC_two_phones.6ec9a842f905769677f9_m91off_zphwni.webp'/>
